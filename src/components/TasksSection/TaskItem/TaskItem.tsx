  ...
  return (
    <>
      <li key={task.id}>
        ...
        <article
className={`bg-white rounded-lg p-3 sm:p-4 flex text-left transition hover:shadow-lg hover:shadow-slate-300 dark:bg-slate-800 dark:hover:shadow-transparent ${
